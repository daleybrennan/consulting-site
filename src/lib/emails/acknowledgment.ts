...
export function acknowledgmentEmail({
  ...
  if (locale === 'fr') {
    return {
      ...
      text: [
        ...
        '',
        `Je prépare personnellement chaque diagnostic tarifaire : une lecture brève et écrite de l'endroit où votre prix atterrit et des questions à trancher, à vous sans engagement. Je reviendrai vers vous sous peu. Si vous souhaitez ajouter quoi que ce soit entre-temps, il vous suffit de répondre à ce message.`,
        '',
        'Bien à vous,',
        'Daley Brennan',
        'Export Consultant',
  ...
  return {
    ...
    text: [
      ...
      '',
      `I prepare each pricing diagnostic personally: a short written read of where your pricing lands and the questions worth answering, yours with no obligation. I'll be in touch shortly. If there's anything you'd like to add in the meantime, just reply to this email.`,
      '',
      'Best regards,',
      'Daley Brennan',
      'Export Consultant',
